...
export class BajajIssueService {
  ...
  bajajlocationList(orgId: any): Observable<any> {
...
bajajuserissuesSearch(issueNo:any,ouId:any,locId:any,deptId:any,sts:any): Observable<any> {
  return this.http.get(this.ServerUrl + `/BajajTrans/AllIssues?issueNo=${issueNo}&ouId=${ouId}&locationId=${locId}&deptId=${deptId}&status=${sts}`);
}

bajajissuesSearch(issueNo:any,ouId:any,locId:any,deptId:any,sts:any): Observable<any> {
  return this.http.get(this.ServerUrl + `/BajajTrans/AllIssues?issueNo=${issueNo}&ouId=${ouId}&locationId=${locId}&deptId=${deptId}&status=${sts}`)
}

IssueNoFindFN(issueNo:any): Observable<any> {
  return this.http.get(this.ServerUrl + `/BajajTrans/getIssue/${issueNo}`);
}
...
public IssuelogSubmit(formdata:FormData) {
  ...
  // };
  const url = this.ServerUrl + '/BajajTrans/addIssue';
...
updateUserIssueLinefn(UpdateCounterSaleInvRecord:FormData,issueNo:any) {
  ...
  //   headers: this.headers
  // };
  const url = (this.ServerUrl + `/BajajTrans/updateIssue?issueNo=${issueNo}`);
  return this.http.put(url, UpdateCounterSaleInvRecord);
}

openDocumentFn(headerId:any,docType:any) {
  const REQUEST_URI = this.ServerUrl + `/BajajTrans/downloadfile?trlineId=${headerId}&filepath=${docType}`;
